...
<body>
    <header>
        ...
        <div>
            <a href="home.php" ><img src="imagens/icon_home.png" alt="" class="home"></a>
        </div>
        <style>
    </style>
    </header>
    ...
    <main>
        <div class="container">
                            ...
                            if (isset($_POST['dados'])) {
                                if (isset($_POST['nome']) && isset($_POST['email'])) {
                                    ...
                                    if ($stmt->affected_rows > 0) {
                                        ...
                                        header("Location: perfilProf.php");
                                    } else {
            ...
            <a href="https://heyzine.com/flip-book/44d388fcf2.html" target="_blank"><div class='manualDoUsuario'><img src="imagens/manualV.png" alt=""><b>Manual do Usuário</b></div></a>
        </div>
    </main>
    ...
    <div class="fundoOpaco" id='modal'>
        <div class="editTabela">
            ...
            <form method='post' enctype='multipart/form-data'>
                ...
                <button type='submit' name='image' id="modal-confirm" class="btn btn-primary">Salvar Imagem</button>
            </form>
        </div>
    </div>
                    ...
                    if ($file['error'] === UPLOAD_ERR_OK) {
                        ...
                        if (move_uploaded_file($file['tmp_name'], $uploadFile)) {
                            ...
                            if ($stmt) {
                                ...
                                if ($stmt->execute()) {
                                    echo '<script>window.location.replace(`perfilProf.php`)</script>';
                                } else {
